...
| 5 | 修正自己紀錄 | 選擇 `feeding_records`, 選擇動物, 選最近一筆 | 修正成功 |
| 6 | 查詢動物趨勢 | 輸入動物 ID | 顯示體重和餵食趨勢 |
| 7 | 修改密碼 | 輸入舊密碼、新密碼 | 密碼修改成功 |
...
| 6 | 修正紀錄 | 選擇 `feeding_records`, 選擇動物 | Admin 可修正任何人的紀錄 |
| 7 | 高風險動物 | 直接查詢 | 顯示需關注的動物列表 |
| 8 | 查詢動物趨勢 | 輸入動物 ID | 顯示體重和餵食趨勢 |
| 9 | 查詢代碼表 | 選擇 `4. 員工` | 顯示所有員工資訊 |
| 10 | 冒失鬼名單 | 直接查詢 | 顯示修正次數 >= 5 的員工 |
| 11 | 管理員工證照 | 員工: `E009`, 證照: `1. Carnivore` | 已授予證照 |
| 12 | 飲食管理 | 查看/新增/移除物種可食用飼料 | 設定成功 |
| 13 | 員工管理 | 新增員工 `E999`, 姓名: `測試員` | 新增成功 |
